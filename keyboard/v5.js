...
function createFinger(m) {
    ...
    var f = Object.assign({
        ...
        keys: [],
        createWell: function() {
          var w = flatWedge(this.r, this.a1-this.padding[0], this.a2+this.padding[1], -2*this.b2+8, -2*this.b1-8);
        ...
        sheer: function() {
        var d = 2*r;
        var r = this.r, a1 = this.b1+4, a2 = this.b2-1, b1 = this.a+this.a1-20, b2 = this.a+this.a2+20;
        ...
        toSolid: function() {
          ...
          base = base.subtract(sphere({r:this.r - SHELL.thickness}).rotateY(this.a)).setColor([1,1,1]).union(w);
          base = base.union(w);
